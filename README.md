...
Open Team Members to review each member's task progress.
Open Dashboard to review status and priority charts.
Log in as a Member.
Open My Tasks and update task status.
Log back in as Admin and delete a task or project if needed.
Notes
